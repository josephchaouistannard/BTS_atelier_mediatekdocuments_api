...
Cette API, écrite en PHP, est une evolution de l'API dans <a href="https://github.com/CNED-SLAM/rest_mediatekdocuments">ce dépôt</a>.<br><br>
...
https://github.com/josephchaouistannard/BTS_atelier_mediatekdocuments
...
<ul>
   ...
   <li><strong>Créer un fichier .env ou juste renommer .env.example.</strong>
...
Dans MyAccessBDD, plusieurs fonctions ont été ajoutées pour répondre aux demandes actuelles de l'application C# MediaTekDocuments. La documentation complète de l'API est disponble <a href="https://mediatekdocuments-api-docs.josephchaouistannard.com/">ici</a>.
